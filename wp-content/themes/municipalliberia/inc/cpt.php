...
function municipalliberia_register_meta_boxes( $meta_boxes )
{
    ...
    $meta_boxes[] = array(
        ...
        'fields' => array(
             ...
             array(
                'name'  => 'Posición Principal',
                'options' =>array(
                    'Portero' => __( 'Portero', 'your-prefix' ),
                    'Defensa Central' => __( 'Defensa Central', 'your-prefix' ),
                    'Lateral Derecho' => __( 'Lateral Derecho', 'your-prefix' ),
                    'Lateral Izquierdo' => __( 'Lateral Izquierdo', 'your-prefix' ),
                    'Mediocampista Defensivo' => __( 'Mediocampista Defensivo', 'your-prefix' ),
                    'Mediocampista Central' => __( 'Mediocampista Central', 'your-prefix' ),
                    'Mediocampista Derecho' => __( 'Mediocampista Derecho', 'your-prefix' ),
                    'Mediocampista Izquierdo' => __( 'Mediocampista Izquierdo', 'your-prefix' ),
                    'Mediocampista Ofensivo' => __( 'Mediocampista Ofensivo', 'your-prefix' ),
                    'Delantero Centro' => __( 'Delantero Centro', 'your-prefix' ),
                    'Delantero Secundario' => __( 'Delantero Secundario', 'your-prefix' ),
                    'Ala Derecha' => __( 'Ala Derecha', 'your-prefix' ),
                    'Ala Izquierda' => __( 'Ala Izquierda', 'your-prefix' ),
                ),
